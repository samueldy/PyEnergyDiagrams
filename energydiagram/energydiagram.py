...
class ED:
    ...
    def plot(
        ...
        ax : plt.Axes
            ...
            created for you.
        bbox_params : dict, optional
            Parameters for drawing a box around the top and bottom text labels
            for each level. Useful for ensuring lines don't make text unreadable.
        ...
        for idx, arrow in enumerate(self.arrows):
            ...
            for i in arrow:
                ...
                middle = (
                    y1 - 0.5 * gap
                )  # warning: this way works for negative HOMO/LUMO energies
                ax.annotate(
                    "",
                    xy=(x1, y1),
                    xytext=(x2, middle),
        ...
        for idx, link in enumerate(self.links):
            ...
            for i in link:
                ...
                line = Line2D([x1, x2], [y1, y2], ls=i[1], linewidth=i[2], color=i[3])
                ax.add_line(line)
